/*:
 ...
 Rewrite the function `reportGrade`, only this time give it two parameters of type `Double` called `totalQuestions` and `correctQuestions`, respectively. It should work exactly the same way as before using the values passed. Call the function and observe the printout.
