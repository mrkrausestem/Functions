/*:
 ...
 One principle that can help in debugging and maintaining code is abstraction. For example, if you are creating an app to calculate the surface area of specific geometric figures, it would be easier to decompose the calculations into smaller functions with specific purposes then to group them all together into 1 big function. (1 points)
 */
/*:
  - Steps
    ...
    3. **Call your area function inside your `calcSAofRectangularPrism` function to find the area of the sides of the prism** (no shortcuts!!)
